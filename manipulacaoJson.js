...
const indiceAnimalRemover = objetoAnimais.animais.findIndex(animal => animal.id === 4);
console.log(`resultado indice animal remover =  ${indiceAnimalRemover}` );
...
console.log(`String Jason = ${novaStringJsonAnimais}`);
